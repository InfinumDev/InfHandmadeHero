...
set CommonCompilerFlags=-MTd -nologo -Gm- -GR- -EHa- -WX -Od -Oi -W4 -wd4201 -wd4456 -wd4505 -wd4100 -wd4189 -DHANDMADE_INTERNAL=1 -DHANDMADE_SLOW=1 -DHANDMADE_WIN32=1 -FC -Z7
...
REM 64-bit build
del *.pdb > NUL 2> NUL
echo WAINTING FOR PDB > lock.tmp
